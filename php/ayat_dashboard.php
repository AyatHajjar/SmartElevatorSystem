    ...
    <section class="controls">
        ...
        <form method="POST" class="floor-buttons">
            ...
            <button
                ...
                name="newfloor"
                value="1"
                onclick="event.preventDefault(); announceFloor(1); setTimeout(() => this.form.submit(), 1500);"
            >
                Floor 1
            </button>
            ...
            <button
                ...
                name="newfloor"
                value="2"
                onclick="event.preventDefault(); announceFloor(2); setTimeout(() => this.form.submit(), 1500);"
            >
            ...
            <button
                ...
                name="newfloor"
                value="3"
                onclick="event.preventDefault(); announceFloor(3); setTimeout(() ==> this.form.submit(), 1500);"
            >
